...
export const prototypes: Prototype[] = [
  ...
  },
  {
    ...
    description:
      'Interactive Storybook cataloguing every chart shape used in customer-facing Command analytics. Highcharts and visx production mirrors, plus live Verity primitive sims (doc-27 tokens, PieDonut, ScheduleChart, color palettes).',
